...
class WebEnabledImproverBot(LangchainBotInterface):
    def __init__(self):
        super().__init__()
        self.tools = [file_content, TavilySearchResults(max_results=3)]
        self.initialize()

    @property
    def bot_type(self) -> str:
        return "web-enabled-improver-bot"

    @property
    def description(self) -> str:
        return "Web-Enabled System Improver Bot - Answer questions about the system and search the web for additional information"
    ...
    def create_chatbot(self):
        def chatbot(state: State):
            ...
            prompt = f"""
            As an AI assistant with web search capabilities, you are tasked with analyzing and suggesting improvements for a software system.
            ...
            5. Use the web search tool when you need up-to-date information or specific facts that are not available in the system files
            6. Be clear and specific in your answers and suggestions
            7. If you're unsure about something, it's okay to admit it
            8. Break down complex information into manageable steps
            9. Use examples where appropriate
            10. Cite sources or provide reasoning for your answers when possible
